...
const navItems = [
  { label: 'Dashboard', href: '/dashboard' },
  {
    ...
    items: [
      ...
      { label: 'Who Gets Subsidies', href: '/who-gets-farm-subsidies' },
      { label: 'How Much Subsidies', href: '/how-much-farm-subsidies' },
      { label: 'Biggest Subsidies', href: '/biggest-farm-subsidies' },
    ],
  },
