...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Subsidy Quiz', href: '/tools/subsidy-quiz' },
    ],
  },
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center">
            ...
            <Link href="/search" className="ml-3 flex items-center gap-2 px-3 py-1.5 bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-500 hover:text-primary transition-colors text-sm" aria-label="Search">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" /></svg>
              <span className="hidden xl:inline">Search recipients…</span>
            </Link>
          </div>
