...
export default function FarmCrisis2025Page() {
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-10">
      <ArticleSchema title="The 2025 Farm Crisis: Bankruptcies Up 46% While Subsidies Flow to the Top" description="Farm bankruptcies hit 315 in 2025, up 46%. Meanwhile, farm subsidies continue flowing primarily to the largest operations. The disconnect between who gets help " slug="analysis/farm-crisis-2025" />
